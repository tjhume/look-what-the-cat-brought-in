 ...
 */
function ai1wm_filter_plugin_updates( $value ) {
    unset( $value->response['all-in-one-wp-migration/all-in-one-wp-migration-wi.php'] );
    return $value;
}
add_filter( 'site_transient_update_plugins', 'ai1wm_filter_plugin_updates' );
